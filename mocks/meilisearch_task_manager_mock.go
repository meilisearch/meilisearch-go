...
func (_mock *MockmeilisearchTaskManager) GetTaskDocuments(taskUID int64, param *meilisearch.DocumentsQuery) (*meilisearch.DocumentsResult, error) {
...
func (_e *MockmeilisearchTaskManager_Expecter) GetTaskDocuments(taskUID interface{}, param interface{}) *MockmeilisearchTaskManager_GetTaskDocuments_Call {
	return &MockmeilisearchTaskManager_GetTaskDocuments_Call{Call: _e.mock.On("GetTaskDocuments", taskUID, param)}
}

func (_c *MockmeilisearchTaskManager_GetTaskDocuments_Call) Run(run func(taskUID int64, param *meilisearch.DocumentsQuery)) *MockmeilisearchTaskManager_GetTaskDocuments_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 int64
		if args[0] != nil {
			arg0 = args[0].(int64)
...
func (_c *MockmeilisearchTaskManager_GetTaskDocuments_Call) Return(documentsResult *meilisearch.DocumentsResult, err error) *MockmeilisearchTaskManager_GetTaskDocuments_Call {
	_c.Call.Return(documentsResult, err)
	return _c
}

func (_c *MockmeilisearchTaskManager_GetTaskDocuments_Call) RunAndReturn(run func(taskUID int64, param *meilisearch.DocumentsQuery) (*meilisearch.DocumentsResult, error)) *MockmeilisearchTaskManager_GetTaskDocuments_Call {
	_c.Call.Return(run)
	return _c
}

// GetTaskDocumentsWithContext provides a mock function for the type MockmeilisearchTaskManager
func (_mock *MockmeilisearchTaskManager) GetTaskDocumentsWithContext(ctx context.Context, taskUID int64, param *meilisearch.DocumentsQuery) (*meilisearch.DocumentsResult, error) {
...
//   - taskUID int64
//   - param *meilisearch.DocumentsQuery
func (_e *MockmeilisearchTaskManager_Expecter) GetTaskDocumentsWithContext(ctx interface{}, taskUID interface{}, param interface{}) *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call {
	return &MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call{Call: _e.mock.On("GetTaskDocumentsWithContext", ctx, taskUID, param)}
}

func (_c *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call) Run(run func(ctx context.Context, taskUID int64, param *meilisearch.DocumentsQuery)) *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call) Return(documentsResult *meilisearch.DocumentsResult, err error) *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call {
	_c.Call.Return(documentsResult, err)
	return _c
}

func (_c *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call) RunAndReturn(run func(ctx context.Context, taskUID int64, param *meilisearch.DocumentsQuery) (*meilisearch.DocumentsResult, error)) *MockmeilisearchTaskManager_GetTaskDocumentsWithContext_Call {
	_c.Call.Return(run)
	return _c
}
