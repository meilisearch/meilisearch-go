		...
		case "sortFacetValuesBy":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v117 SortFacetType
					v117 = SortFacetType(in.String())
					(out.SortFacetValuesBy)[key] = v117
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo33(out *jwriter.Writer, in Faceting) {
	...
	}
	{
		...
		if in.SortFacetValuesBy == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v118First := true
			for v118Name, v118Value := range in.SortFacetValuesBy {
				if v118First {
					v118First = false
				} else {
					out.RawByte(',')
		...
		case "facetHits":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FacetHits = append(out.FacetHits, v119)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo34(out *jwriter.Writer, in FacetSearchResponse) {
	...
	_ = first
	{
		...
		if in.FacetHits == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v120, v121 := range in.FacetHits {
				if v120 > 0 {
					out.RawByte(',')
				}
				if m, ok := v121.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v121.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v121))
				}
			}
			out.RawByte(']')
		}
		...
		case "attributesToSearchOn":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToSearchOn = append(out.AttributesToSearchOn, v122)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo35(out *jwriter.Writer, in FacetSearchRequest) {
	...
	if len(in.AttributesToSearchOn) != 0 {
		...
		{
			out.RawByte('[')
			for v123, v124 := range in.AttributesToSearchOn {
				if v123 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v125 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v125 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v126 interface{}
							if m, ok := v126.(easyjson.Unmarshaler); ok {
								m.UnmarshalEasyJSON(in)
							} else if m, ok := v126.(json.Unmarshaler); ok {
								_ = m.UnmarshalJSON(in.Raw())
							} else {
								v126 = in.Interface()
							}
					...
					out.Results = append(out.Results, v125)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo37(out *jwriter.Writer, in DocumentsResult) {
	...
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v127, v128 := range in.Results {
				if v127 > 0 {
					out.RawByte(',')
				}
				if v128 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					...
					for v129Name, v129Value := range v128 {
						...
						out.RawByte(':')
						if m, ok := v129Value.(easyjson.Marshaler); ok {
							m.MarshalEasyJSON(out)
						} else if m, ok := v129Value.(json.Marshaler); ok {
							out.Raw(m.MarshalJSON())
						} else {
							out.Raw(json.Marshal(v129Value))
						}
					}
					out.RawByte('}')
				}
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v130)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "rankingRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RankingRules = append(out.RankingRules, v136)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "searchableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SearchableAttributes = append(out.SearchableAttributes, v137)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v138)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v139)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v142)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v143)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "swaps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v144 SwapIndexesParams
					(v144).UnmarshalEasyJSON(in)
					out.Swaps = append(out.Swaps, v144)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo40(out *jwriter.Writer, in Details) {
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v145, v146 := range in.RankingRules {
				if v145 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v147, v148 := range in.SearchableAttributes {
				if v147 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v149, v150 := range in.DisplayedAttributes {
				if v149 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v151, v152 := range in.StopWords {
				if v151 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v153First := true
			for v153Name, v153Value := range in.Synonyms {
				if v153First {
					v153First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v153Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v154, v155 := range v153Value {
						if v154 > 0 {
							out.RawByte(',')
						}
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v156, v157 := range in.FilterableAttributes {
				if v156 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v158, v159 := range in.SortableAttributes {
				if v158 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v163)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v164 TaskStatus
					v164 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v164)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v165 TaskType
					v165 = TaskType(in.String())
					out.Types = append(out.Types, v165)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CanceledBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v166 int64
					v166 = int64(in.Int64())
					out.CanceledBy = append(out.CanceledBy, v166)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo41(out *jwriter.Writer, in DeleteTasksQuery) {
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v169, v170 := range in.IndexUIDS {
				if v169 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v171, v172 := range in.Statuses {
				if v171 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CanceledBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v175, v176 := range in.CanceledBy {
				if v175 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v178)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v179 TaskStatus
					v179 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v179)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v180 TaskType
					v180 = TaskType(in.String())
					out.Types = append(out.Types, v180)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo44(out *jwriter.Writer, in CancelTasksQuery) {
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v183, v184 := range in.IndexUIDS {
				if v183 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v185, v186 := range in.Statuses {
				if v185 > 0 {
					out.RawByte(',')
				}
