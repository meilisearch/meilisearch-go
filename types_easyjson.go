	...
	for !in.IsDelim('}') {
		...
		case "dictionary":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Dictionary = append(out.Dictionary, v40)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "separatorTokens":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SeparatorTokens = append(out.SeparatorTokens, v41)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "nonSeparatorTokens":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.NonSeparatorTokens = append(out.NonSeparatorTokens, v42)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v43)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v44)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v47)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v48)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "localizedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v49 *LocalizedAttributes
					if in.IsNull() {
						in.Skip()
						v49 = nil
					} else {
						if v49 == nil {
							v49 = new(LocalizedAttributes)
						}
						(*v49).UnmarshalEasyJSON(in)
					}
					out.LocalizedAttributes = append(out.LocalizedAttributes, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo15(out *jwriter.Writer, in Settings) {
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v51, v52 := range in.RankingRules {
				if v51 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v53, v54 := range in.SearchableAttributes {
				if v53 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Dictionary) != 0 {
		...
		{
			out.RawByte('[')
			for v55, v56 := range in.Dictionary {
				if v55 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SeparatorTokens) != 0 {
		...
		{
			out.RawByte('[')
			for v57, v58 := range in.SeparatorTokens {
				if v57 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.NonSeparatorTokens) != 0 {
		...
		{
			out.RawByte('[')
			for v59, v60 := range in.NonSeparatorTokens {
				if v59 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v61, v62 := range in.DisplayedAttributes {
				if v61 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v63, v64 := range in.StopWords {
				if v63 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v65First := true
			for v65Name, v65Value := range in.Synonyms {
				if v65First {
					v65First = false
				} else {
					out.RawByte(',')
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v68, v69 := range in.FilterableAttributes {
				if v68 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v70, v71 := range in.SortableAttributes {
				if v70 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.LocalizedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v72, v73 := range in.LocalizedAttributes {
				if v72 > 0 {
					out.RawByte(',')
				}
				if v73 == nil {
	...
	if len(in.Embedders) != 0 {
		...
		}
		{
			out.RawByte('{')
			v74First := true
			for v74Name, v74Value := range in.Embedders {
				if v74First {
					v74First = false
				} else {
					out.RawByte(',')
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo16(out *jwriter.Writer, in SearchResponse) {
	...
	_ = first
	{
		...
		if in.Hits == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v76, v77 := range in.Hits {
				if v76 > 0 {
					out.RawByte(',')
				}
				if m, ok := v77.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v77.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v77))
				}
			}
			out.RawByte(']')
		}
	...
	for !in.IsDelim('}') {
		...
		case "attributesToRetrieve":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToRetrieve = append(out.AttributesToRetrieve, v78)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "attributesToSearchOn":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToSearchOn = append(out.AttributesToSearchOn, v79)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "attributesToCrop":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToCrop = append(out.AttributesToCrop, v80)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "attributesToHighlight":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToHighlight = append(out.AttributesToHighlight, v81)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "facets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Facets = append(out.Facets, v82)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "vector":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Vector = append(out.Vector, v84)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "locales":
			if in.IsNull() {
				...
				if out.Locate == nil {
					if !in.IsDelim(']') {
						out.Locate = make([]Locate, 0, 4)
					} else {
						out.Locate = []Locate{}
					}
				} else {
					out.Locate = (out.Locate)[:0]
				}
				for !in.IsDelim(']') {
					var v85 Locate
					v85 = Locate(in.String())
					out.Locate = append(out.Locate, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo18(out *jwriter.Writer, in SearchRequest) {
	...
	if len(in.AttributesToRetrieve) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.AttributesToRetrieve {
				if v86 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttributesToSearchOn) != 0 {
		...
		{
			out.RawByte('[')
			for v88, v89 := range in.AttributesToSearchOn {
				if v88 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttributesToCrop) != 0 {
		...
		{
			out.RawByte('[')
			for v90, v91 := range in.AttributesToCrop {
				if v90 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttributesToHighlight) != 0 {
		...
		{
			out.RawByte('[')
			for v92, v93 := range in.AttributesToHighlight {
				if v92 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo19(in *jlexer.Lexer, out *SearchFederationOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo19(out *jwriter.Writer, in SearchFederationOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo20(in *jlexer.Lexer, out *Pagination) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo20(out *jwriter.Writer, in Pagination) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo21(in *jlexer.Lexer, out *MultiSearchResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "hits":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v103 interface{}
					if m, ok := v103.(easyjson.Unmarshaler); ok {
						m.UnmarshalEasyJSON(in)
					} else if m, ok := v103.(json.Unmarshaler); ok {
						_ = m.UnmarshalJSON(in.Raw())
					} else {
						v103 = in.Interface()
					}
					out.Hits = append(out.Hits, v103)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo21(out *jwriter.Writer, in MultiSearchResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Results) != 0 {
		...
		{
			out.RawByte('[')
			for v104, v105 := range in.Results {
				if v104 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Hits) != 0 {
		...
		{
			out.RawByte('[')
			for v106, v107 := range in.Hits {
				if v106 > 0 {
					out.RawByte(',')
				}
				if m, ok := v107.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v107.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v107))
				}
			}
			out.RawByte(']')
		}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo22(in *jlexer.Lexer, out *MultiSearchRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "queries":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v108 *SearchRequest
					if in.IsNull() {
						in.Skip()
						v108 = nil
					} else {
						if v108 == nil {
							v108 = new(SearchRequest)
						}
						(*v108).UnmarshalEasyJSON(in)
					}
					out.Queries = append(out.Queries, v108)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo22(out *jwriter.Writer, in MultiSearchRequest) {
	out.RawByte('{')
	first := true
	_ = first
	...
	}
	{
		...
		if in.Queries == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v109, v110 := range in.Queries {
				if v109 > 0 {
					out.RawByte(',')
				}
				if v110 == nil {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo23(in *jlexer.Lexer, out *MultiSearchFederation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo23(out *jwriter.Writer, in MultiSearchFederation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Offset != 0 {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo24(in *jlexer.Lexer, out *MinWordSizeForTypos) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo24(out *jwriter.Writer, in MinWordSizeForTypos) {
	out.RawByte('{')
	first := true
	_ = first
	if in.OneTypo != 0 {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo25(in *jlexer.Lexer, out *LocalizedAttributes) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "attributePatterns":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributePatterns = append(out.AttributePatterns, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo25(out *jwriter.Writer, in LocalizedAttributes) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Locales) != 0 {
		...
		{
			out.RawByte('[')
			for v113, v114 := range in.Locales {
				if v113 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AttributePatterns) != 0 {
		...
		{
			out.RawByte('[')
			for v115, v116 := range in.AttributePatterns {
				if v115 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo26(in *jlexer.Lexer, out *KeysResults) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo26(out *jwriter.Writer, in KeysResults) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v118, v119 := range in.Results {
				if v118 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo27(in *jlexer.Lexer, out *KeysQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo27(out *jwriter.Writer, in KeysQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo28(in *jlexer.Lexer, out *KeyUpdate) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo28(out *jwriter.Writer, in KeyUpdate) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo29(in *jlexer.Lexer, out *KeyParsed) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Actions = append(out.Actions, v120)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "indexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Indexes = append(out.Indexes, v121)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo29(out *jwriter.Writer, in KeyParsed) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Actions) != 0 {
		...
		{
			out.RawByte('[')
			for v122, v123 := range in.Actions {
				if v122 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Indexes) != 0 {
		...
		{
			out.RawByte('[')
			for v124, v125 := range in.Indexes {
				if v124 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo30(in *jlexer.Lexer, out *Key) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Actions = append(out.Actions, v126)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "indexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Indexes = append(out.Indexes, v127)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo30(out *jwriter.Writer, in Key) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Actions) != 0 {
		...
		{
			out.RawByte('[')
			for v128, v129 := range in.Actions {
				if v128 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Indexes) != 0 {
		...
		{
			out.RawByte('[')
			for v130, v131 := range in.Indexes {
				if v130 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo31(in *jlexer.Lexer, out *IndexesResults) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v132 *IndexResult
					if in.IsNull() {
						in.Skip()
						v132 = nil
					} else {
						if v132 == nil {
							v132 = new(IndexResult)
						}
						(*v132).UnmarshalEasyJSON(in)
					}
					out.Results = append(out.Results, v132)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo31(out *jwriter.Writer, in IndexesResults) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v133, v134 := range in.Results {
				if v133 > 0 {
					out.RawByte(',')
				}
				if v134 == nil {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo32(in *jlexer.Lexer, out *IndexesQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo32(out *jwriter.Writer, in IndexesQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo33(in *jlexer.Lexer, out *IndexResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo33(out *jwriter.Writer, in IndexResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo34(in *jlexer.Lexer, out *IndexConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo34(out *jwriter.Writer, in IndexConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo35(in *jlexer.Lexer, out *Health) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo35(out *jwriter.Writer, in Health) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo36(in *jlexer.Lexer, out *Faceting) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "sortFacetValuesBy":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v135 SortFacetType
					v135 = SortFacetType(in.String())
					(out.SortFacetValuesBy)[key] = v135
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo36(out *jwriter.Writer, in Faceting) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.SortFacetValuesBy == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v136First := true
			for v136Name, v136Value := range in.SortFacetValuesBy {
				if v136First {
					v136First = false
				} else {
					out.RawByte(',')
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo37(in *jlexer.Lexer, out *FacetSearchResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "facetHits":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v137 interface{}
					if m, ok := v137.(easyjson.Unmarshaler); ok {
						m.UnmarshalEasyJSON(in)
					} else if m, ok := v137.(json.Unmarshaler); ok {
						_ = m.UnmarshalJSON(in.Raw())
					} else {
						v137 = in.Interface()
					}
					out.FacetHits = append(out.FacetHits, v137)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo37(out *jwriter.Writer, in FacetSearchResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.FacetHits == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v138, v139 := range in.FacetHits {
				if v138 > 0 {
					out.RawByte(',')
				}
				if m, ok := v139.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v139.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v139))
				}
			}
			out.RawByte(']')
		}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo38(in *jlexer.Lexer, out *FacetSearchRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "attributesToSearchOn":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToSearchOn = append(out.AttributesToSearchOn, v140)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo38(out *jwriter.Writer, in FacetSearchRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FacetName != "" {
	...
	if len(in.AttributesToSearchOn) != 0 {
		...
		{
			out.RawByte('[')
			for v141, v142 := range in.AttributesToSearchOn {
				if v141 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo39(in *jlexer.Lexer, out *ExperimentalFeaturesResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo39(out *jwriter.Writer, in ExperimentalFeaturesResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo40(in *jlexer.Lexer, out *ExperimentalFeaturesBase) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo40(out *jwriter.Writer, in ExperimentalFeaturesBase) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo41(in *jlexer.Lexer, out *Embedder) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo41(out *jwriter.Writer, in Embedder) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo42(in *jlexer.Lexer, out *DocumentsResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v143 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v143 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v144 interface{}
							if m, ok := v144.(easyjson.Unmarshaler); ok {
								m.UnmarshalEasyJSON(in)
							} else if m, ok := v144.(json.Unmarshaler); ok {
								_ = m.UnmarshalJSON(in.Raw())
							} else {
								v144 = in.Interface()
							}
					...
					out.Results = append(out.Results, v143)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo42(out *jwriter.Writer, in DocumentsResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v145, v146 := range in.Results {
				if v145 > 0 {
					out.RawByte(',')
				}
				if v146 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v147First := true
					for v147Name, v147Value := range v146 {
						if v147First {
							v147First = false
						} else {
							out.RawByte(',')
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo43(in *jlexer.Lexer, out *DocumentsQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v148)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo43(out *jwriter.Writer, in DocumentsQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Offset != 0 {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo44(in *jlexer.Lexer, out *DocumentQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v151)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo44(out *jwriter.Writer, in DocumentQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Fields) != 0 {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo45(in *jlexer.Lexer, out *Details) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rankingRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RankingRules = append(out.RankingRules, v154)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "searchableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SearchableAttributes = append(out.SearchableAttributes, v155)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v156)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v157)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v160)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v161)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "swaps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v162 SwapIndexesParams
					(v162).UnmarshalEasyJSON(in)
					out.Swaps = append(out.Swaps, v162)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo45(out *jwriter.Writer, in Details) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v163, v164 := range in.RankingRules {
				if v163 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v165, v166 := range in.SearchableAttributes {
				if v165 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v167, v168 := range in.DisplayedAttributes {
				if v167 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v169, v170 := range in.StopWords {
				if v169 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v171First := true
			for v171Name, v171Value := range in.Synonyms {
				if v171First {
					v171First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v171Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v172, v173 := range v171Value {
						if v172 > 0 {
							out.RawByte(',')
						}
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v174, v175 := range in.FilterableAttributes {
				if v174 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v176, v177 := range in.SortableAttributes {
				if v176 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo46(in *jlexer.Lexer, out *DeleteTasksQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v181)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v182 TaskStatus
					v182 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v182)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v183 TaskType
					v183 = TaskType(in.String())
					out.Types = append(out.Types, v183)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CanceledBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v184 int64
					v184 = int64(in.Int64())
					out.CanceledBy = append(out.CanceledBy, v184)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo46(out *jwriter.Writer, in DeleteTasksQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v187, v188 := range in.IndexUIDS {
				if v187 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v189, v190 := range in.Statuses {
				if v189 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CanceledBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v193, v194 := range in.CanceledBy {
				if v193 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo47(in *jlexer.Lexer, out *CsvDocumentsQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo47(out *jwriter.Writer, in CsvDocumentsQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.PrimaryKey != "" {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo48(in *jlexer.Lexer, out *CreateIndexRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo48(out *jwriter.Writer, in CreateIndexRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UID != "" {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo49(in *jlexer.Lexer, out *CancelTasksQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v196)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v197 TaskStatus
					v197 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v197)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v198 TaskType
					v198 = TaskType(in.String())
					out.Types = append(out.Types, v198)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo49(out *jwriter.Writer, in CancelTasksQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v201, v202 := range in.IndexUIDS {
				if v201 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v203, v204 := range in.Statuses {
				if v203 > 0 {
					out.RawByte(',')
				}
