	...
	for !in.IsDelim('}') {
		...
		case "queries":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v99 *SearchRequest
					if in.IsNull() {
						in.Skip()
						v99 = nil
					} else {
						if v99 == nil {
							v99 = new(SearchRequest)
						}
						(*v99).UnmarshalEasyJSON(in)
					}
					out.Queries = append(out.Queries, v99)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo21(out *jwriter.Writer, in MultiSearchRequest) {
	...
	_ = first
	{
		...
		if in.Queries == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v100, v101 := range in.Queries {
				if v100 > 0 {
					out.RawByte(',')
				}
				if v101 == nil {
		...
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Actions = append(out.Actions, v105)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "indexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Indexes = append(out.Indexes, v106)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo26(out *jwriter.Writer, in KeyParsed) {
	...
	if len(in.Actions) != 0 {
		...
		{
			out.RawByte('[')
			for v107, v108 := range in.Actions {
				if v107 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Indexes) != 0 {
		...
		{
			out.RawByte('[')
			for v109, v110 := range in.Indexes {
				if v109 > 0 {
					out.RawByte(',')
				}
		...
		case "actions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Actions = append(out.Actions, v111)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "indexes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Indexes = append(out.Indexes, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo27(out *jwriter.Writer, in Key) {
	...
	if len(in.Actions) != 0 {
		...
		{
			out.RawByte('[')
			for v113, v114 := range in.Actions {
				if v113 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Indexes) != 0 {
		...
		{
			out.RawByte('[')
			for v115, v116 := range in.Indexes {
				if v115 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v117 *IndexResult
					if in.IsNull() {
						in.Skip()
						v117 = nil
					} else {
						if v117 == nil {
							v117 = new(IndexResult)
						}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo30(in *jlexer.Lexer, out *IndexResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo30(out *jwriter.Writer, in IndexResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo31(in *jlexer.Lexer, out *IndexConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo31(out *jwriter.Writer, in IndexConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo32(in *jlexer.Lexer, out *Health) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo32(out *jwriter.Writer, in Health) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo33(in *jlexer.Lexer, out *Faceting) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "sortFacetValuesBy":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v120 SortFacetType
					v120 = SortFacetType(in.String())
					(out.SortFacetValuesBy)[key] = v120
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo33(out *jwriter.Writer, in Faceting) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.SortFacetValuesBy == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v121First := true
			for v121Name, v121Value := range in.SortFacetValuesBy {
				if v121First {
					v121First = false
				} else {
					out.RawByte(',')
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo34(in *jlexer.Lexer, out *FacetSearchResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "facetHits":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v122 interface{}
					if m, ok := v122.(easyjson.Unmarshaler); ok {
						m.UnmarshalEasyJSON(in)
					} else if m, ok := v122.(json.Unmarshaler); ok {
						_ = m.UnmarshalJSON(in.Raw())
					} else {
						v122 = in.Interface()
					}
					out.FacetHits = append(out.FacetHits, v122)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo34(out *jwriter.Writer, in FacetSearchResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.FacetHits == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v123, v124 := range in.FacetHits {
				if v123 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo35(in *jlexer.Lexer, out *FacetSearchRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "attributesToSearchOn":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToSearchOn = append(out.AttributesToSearchOn, v125)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo35(out *jwriter.Writer, in FacetSearchRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FacetName != "" {
	...
	if len(in.AttributesToSearchOn) != 0 {
		...
		{
			out.RawByte('[')
			for v126, v127 := range in.AttributesToSearchOn {
				if v126 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo36(in *jlexer.Lexer, out *ExperimentalFeaturesResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo36(out *jwriter.Writer, in ExperimentalFeaturesResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo37(in *jlexer.Lexer, out *ExperimentalFeaturesBase) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo37(out *jwriter.Writer, in ExperimentalFeaturesBase) {
	out.RawByte('{')
	first := true
	_ = first
	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v128 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v128 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v129 interface{}
							if m, ok := v129.(easyjson.Unmarshaler); ok {
								m.UnmarshalEasyJSON(in)
							} else if m, ok := v129.(json.Unmarshaler); ok {
								_ = m.UnmarshalJSON(in.Raw())
							} else {
								v129 = in.Interface()
							}
					...
					out.Results = append(out.Results, v128)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo39(out *jwriter.Writer, in DocumentsResult) {
	...
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v130, v131 := range in.Results {
				if v130 > 0 {
					out.RawByte(',')
				}
				if v131 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v132First := true
					for v132Name, v132Value := range v131 {
						if v132First {
							v132First = false
						} else {
							out.RawByte(',')
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v133)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "rankingRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RankingRules = append(out.RankingRules, v139)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "searchableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SearchableAttributes = append(out.SearchableAttributes, v140)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v141)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v142)
					in.WantComma()
				}
				in.Delim(']')
			}
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						for !in.IsDelim(']') {
							...
							v143 = append(v143, v144)
							in.WantComma()
						}
						in.Delim(']')
					}
					(out.Synonyms)[key] = v143
					in.WantComma()
				}
				in.Delim('}')
			}
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v145)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v146)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "swaps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v147 SwapIndexesParams
					(v147).UnmarshalEasyJSON(in)
					out.Swaps = append(out.Swaps, v147)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo42(out *jwriter.Writer, in Details) {
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v148, v149 := range in.RankingRules {
				if v148 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v150, v151 := range in.SearchableAttributes {
				if v150 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v152, v153 := range in.DisplayedAttributes {
				if v152 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v154, v155 := range in.StopWords {
				if v154 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v156First := true
			for v156Name, v156Value := range in.Synonyms {
				if v156First {
					v156First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v156Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v157, v158 := range v156Value {
						if v157 > 0 {
							out.RawByte(',')
						}
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v159, v160 := range in.FilterableAttributes {
				if v159 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v161, v162 := range in.SortableAttributes {
				if v161 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v166)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v167 TaskStatus
					v167 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v167)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v168 TaskType
					v168 = TaskType(in.String())
					out.Types = append(out.Types, v168)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CanceledBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v169 int64
					v169 = int64(in.Int64())
					out.CanceledBy = append(out.CanceledBy, v169)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo43(out *jwriter.Writer, in DeleteTasksQuery) {
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v172, v173 := range in.IndexUIDS {
				if v172 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v174, v175 := range in.Statuses {
				if v174 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CanceledBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v178, v179 := range in.CanceledBy {
				if v178 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo46(out *jwriter.Writer, in CancelTasksQuery) {
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v186, v187 := range in.IndexUIDS {
				if v186 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v188, v189 := range in.Statuses {
				if v188 > 0 {
					out.RawByte(',')
				}
